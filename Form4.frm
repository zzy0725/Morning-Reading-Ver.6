...
SetLayeredWindowAttributes hWnd, RGB(256, 256, 256), 220, LWA_COLORKEY
...
'save as
Open "C://早读/chinesetoday.txt" For Output As #1
Print #1, Text1.Text
Close #1
End Sub
...
'open as
Open "C://早读/chineselishetoday.txt" For Input As #1
Do Until EOF(1)
